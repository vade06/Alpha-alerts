...
def check_new_coinbase_assets(
    ...
    # Only happens with an empty database
    if not seen_assets:
...
def check_crypto_symbol(
    ...
    # We haven't collected enough history yet
    if not old:
...
def main():
    ...
    while True:
        ...
        # Clean database roughly once per hour
        loop_count += 1
